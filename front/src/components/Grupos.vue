              ...
              <div class="modal-body">
                <Form @submit="crearGrupo" :validation-schema="schema">
                  <div class="form-group">
                    ...
                    <ErrorMessage name="nombre" class="error-feedback alert-danger" />
                  </div>
                  <div class="form-group">
...
*/
  data() {
    const schema = yup.object().shape({
      nombre: yup.string().required("Introduza un nome para o grupo"),
      visibilidad: yup.boolean().required("seleccione unha das opcións"),
    });
